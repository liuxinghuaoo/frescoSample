...
//	  roundingParams. setCornersRadius(10);//fresco:roundedCornerRadius="1dp"圆角
//	  roundingParams.setOverlayColor(overlayColor);//fresco:roundWithOverlayColor="@color/corner_color"
//	  roundingParams.setRoundAsCircle(true);//圆
...
//			  .setMinDecodeIntervalMs(intervalMs)//最小解码间隔（分位单位）
  ...
  //图片显示
  public static ImageRequest getImageRequest(int Width,int Height,String uri){
